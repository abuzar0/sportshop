...
<body>
    ...
    <Section>
    <div class="main-bg" style="background-color:rgb(65, 65, 64)">
    ...
    <hr>
    <h3 style="color:red;text-align:center;justify-contant:center;">SwimmingKet</h3>
    <Section>
        <br>
        <div class="container">
